    ...
    <div className="p-6">
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full p-3 pl-10 border rounded-lg bg-white border-gray-300 focus:ring-2 focus:ring-blue-500"
        />
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <div className="relative">
            ...
            <input type="text" placeholder="Name" value={form.name} onChange={(e) => setForm({...form, name: e.target.value})} className="w-full p-2 pl-10 border rounded bg-gray-50 border-gray-300" required />
          </div>
          <div className="relative">
            ...
            <input type="email" placeholder="Email" value={form.email} onChange={(e) => setForm({...form, email: e.target.value})} className="w-full p-2 pl-10 border rounded bg-gray-50 border-gray-300" required />
          </div>
          <div className="relative">
            ...
            <input type="text" placeholder="Phone" value={form.phone} onChange={(e) => setForm({...form, phone: e.target.value})} className="w-full p-2 pl-10 border rounded bg-gray-50 border-gray-300" required />
          </div>
          <div className="relative">
            ...
            <input type="text" placeholder="Company" value={form.company} onChange={(e) => setForm({...form, company: e.target.value})} className="w-full p-2 pl-10 border rounded bg-gray-50 border-gray-300" />
          </div>
          <div className="relative">
            ...
            <select value={form.status} onChange={(e) => setForm({...form, status: e.target.value})} className="w-full p-2 pl-10 border rounded bg-gray-50 border-gray-300 appearance-none">
      ...
      {isLoading ? (
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <table className="w-full">
            ...
            <tbody>
              {customers.map(c => (
                <tr key={c._id} className="border-t border-gray-200 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="p-3 flex gap-2">
                    <button onClick={() => handleEdit(c)} className="text-blue-600 hover:text-blue-800" title="Edit"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" /><path fillRule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clipRule="evenodd" /></svg></button>
                    <button onClick={() => handleDelete(c._id)} className="text-red-600 hover:text-red-800" title="Delete"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm4 0a1 1 0 012 0v6a1 1 0 11-2 0V8z" clipRule="evenodd" /></svg></button>
                  </td>
                </tr>
              ))}
            </tbody>
